...
// Vendored from io.github.ehsannarmani:compose-charts fork (0.0.17-js4).
// The library declared this as expect/actual, but every actual just delegated to
// the common implementation below, so it is collapsed into a single common fun.
fun Modifier.pointerInteropFilter(onTouchEvent: (MotionEvent) -> Boolean): Modifier =
    pointerInteropFilterCommon(onTouchEvent)
