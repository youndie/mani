...
- [ ] **M0-01 · P0 · S** — Чужую транзакцию можно перезаписать и присвоить через `PATCH`
...
- [ ] **M0-05 · P1 · S** — Нет `StatusPages`: мусорный `ObjectId` даёт 500, а на native исключение не логируется
...
- [ ] **M1-01 · P0 · S** — Секрет подписи по умолчанию — строка `secret`
