...
- [x] **M2-01 · P1 · XS** — Удаление категории без сети роняет приложение
...
- [x] **M2-02 · P1 · M** — Истёкшая сессия не ведёт на витрину
...
- [x] **M2-04 · P2 · M** — История и главная по-разному переживают отказ сети
